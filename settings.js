...
🤷‍♀️මොකද්ද ඕන උදව්ව?😉` //Costomize Alive Message (type your message in `` )
...
//bot body 
global.alivepic = `https://telegra.ph/file/617fa2a11ee9636602373.jpg` // alive picture \\ use "https://telegra.ph.jpg" to upload photos. < 1 MB
...
global.mess = {
    success: 'ඉවරයි ✅',
    admin: 'ඇඩ්මින්ට විතරයි පුලුවන්😉',
    botAdmin: 'මට ඇඩ්මින් කෙනෙක් වෙන්න ඕනෙ😥',
    owner: 'අයිතිකරුට විතරයි 😉',
    group: 'මෙය ගෲප් සදහා පමණයි!',
    private: 'මෙය පුද්ගලික චැට් සදහා පමණයි!',
    bot: 'මෙය මට පමණයි😝',
    wait: '👉👈පොඩ්ඩක් ඉන්න...🔄',
    error: 'හපොයි!!! API key එක කල් ඉකුත් වෙලා😯!',
    endLimit: 'දවසේ සීමාව ඉක්මවා ඇත🥴, සීමාව සෑම පැය 12 කට වරක් සකසනු ලැබේ😁',
    linkm: 'කොහෙද ලින්ක් එක?🤔',
    nsfw: 'nsfw එක සක්‍රීය කරල නෑ😕, ඇඩ්මින්ට කියන්න ඒක සක්‍රීය කරයි🙂',
    banChat: 'මේ ගෲප් එකේ ඉදල බොට්ට කෙලවෙලා😕, මගෙ බොසාට කියන්න ඌ හදයි😏',
    badwords: '*🚫නරක වචන කියන්න එපා👿 !*\n\n⚠️ ආයෙ කිව්වොත් පන්නනව... ⚠️',
    spam: '⚠️ [SPAM] අනාවරණය විය ⚠️\n\nහදිසි ආරක්ශක සේවාව ක්‍රියාත්මක කර ඇත.\n\nPowered By: *😁ඇන්ඩ්‍රොයිඩ්😁*',
    caption: 'Generated by: ◉ *𝐊𝐌𝐊 𝐁𝐎𝐓*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
